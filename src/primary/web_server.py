...
from src.primary.apps.blueprints import sonarr_bp, radarr_bp, lidarr_bp, readarr_bp, whisparr_bp, eros_bp, swaparr_bp, sportarr_bp
...
app.register_blueprint(sportarr_bp, url_prefix='/api/sportarr')
